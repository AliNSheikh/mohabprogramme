...
class update extends StatelessWidget {
  employmodel model;
  String section;
  update({required this.model,required this.section});
  ...
  Widget build(BuildContext context) {
    ...
    totalsal.text=model.totalsal!;
    basicsal.text=model.basicsal!;
    sknsal.text=model.sknsal!;
    metrosal.text=model.metrosal!;
    foodsal.text=model.foodsal!;
    passnum.text=model.passnum!;
    visanum.text=model.visanum!;
    fullnum.text=model.fullnum!;
    startdate.text=model.starttime;
    passdate.text=model.passtime!;
    workcarddate.text=model.workcardtime;
    visadate.text=model.visatime;
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text('تعديل معلومات الموظف'),
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: profcov == null
                                        ? DecorationImage(
                                      image: NetworkImage('${model.url?.url}'),
                                      fit: BoxFit.cover,
                                    )
                                        : DecorationImage(
                            ...
                            child: MaterialButton(
                              onPressed: () async {
                                if(formkey.currentState!.validate()){
                                  await  appcubit.get(context).updateemp(
                                      name: username.text,
                                      ...
                                      passnum: passnum.text, section: section, uid: model.uid!);
                                }
